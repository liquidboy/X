...
namespace X.Extension.ThirdParty.MetroVectors.Services
{
    public sealed class CallService : IBackgroundTask
    {
        ...
        private async void AppServiceConnection_RequestReceived(AppServiceConnection sender, AppServiceRequestReceivedEventArgs args)
        {
            ...
            switch (command) {
                case "UI":
                    returnData.Add("sketch-test", "X.Extension.ThirdParty.MetroVectors.UI.Test");
                    returnData.Add("sketch-home", "X.Extension.ThirdParty.MetroVectors.UI.Home");
                    break;
